...
alias list-forward='iptables --list FORWARD -v -n |less'
alias list-input='iptables --list INPUT -v -n |less'
alias list-output='iptables --list OUTPUT -v -n |less'
alias list-nat='iptables -t nat --list -v -n |less'
alias list-ssh='iptables --list f2b-sshd -v -n |less'
alias zero='/root/firewall/zero'
alias updater='apt update;apt dist-upgrade'
alias wget='wget --no-hsts'
alias du-g='du --block-size=g'
